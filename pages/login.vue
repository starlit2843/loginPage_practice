<template>
    <div class="h-[100vh] mx-auto flex max-w-lg grow flex-col overflow-auto">
      <div class="flex h-full flex-col gap-[10vh] overflow-y-scroll bg-[url('images/UserPageBackground.png')] px-9 py-[5vh]">
        ...
        <div class="flex flex-col gap-10">
          <div class="flex flex-col gap-7">
            ...
            <div class="flex flex-col gap-1">
              ...
              <div class="min-h-[5rem] break-all rounded-lg bg-base px-6 pt-3 pb-5 text-base-content shadow-special-cta-02">
                {{ introduction }}
              </div>
            </div>
          </div>
  ...
  import ComponentPublicLink from '~/components/ComponentPublicLink.vue';;
  ...
  const userPicSrc = ref('images/EmptyUser.26402e9e.png');
