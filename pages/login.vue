<template>
      ...
      <div class="flex h-full flex-col gap-[10vh] overflow-y-scroll bg-[url('~/assets/images/UserPageBackground.png')] px-9 py-[5vh]">
        ...
        <div class="flex flex-col gap-10">
          <div class="flex flex-col gap-7">
            ...
            <ComponentTitleWord :titleWord="titleWord_Intro"></ComponentTitleWord>
          ...
          <div class="flex flex-col gap-5">
            <div class="flex flex-col gap-1">
                ...
                <ComponentPublicLink :link="link1" />
                <ComponentPublicLink :link="link2" />-->
                <ComponentTitleWord :titleWord="titleWord_Link"></ComponentTitleWord>
                <draggable v-model="links.list" group="links" animation=2000 >
                  <template #item="{element}">
                    <div class="mb-3">
                      <ComponentPublicLink :link="element.link" />
                    </div>
                  </template>
                </draggable>
            </div>
  ...
  import ComponentTitleWord from '~/components/titleWord.vue'
  ...
  const titleWord_Intro = ref('自我介紹');
  const titleWord_Link = ref('公開連結');

  //const link1 = ref('https://www.google.com.tw/?hl=zh_TW');
  //const link2 = ref('https://www.itxst.com/vue-draggable-next/tutorial.html');
  const links=reactive({
    list:[
      {link:'https://www.google.com.tw/?hl=zh_TW',id:0},
      {link:'https://www.itxst.com/vue-draggable-next/tutorial.html',id:1}
    ]
  });
